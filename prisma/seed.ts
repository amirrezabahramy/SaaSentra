import { PrismaClient, ServiceControlType, ServiceDeployStatus } from "@prisma/client";
...
async function main() {
  ...
  const tenants = [
    { name: "Acme Inc", slug: "acme", plan: pro, enabled: ["flag.sso", "flag.webhooks", "flag.api-access"] },
    { name: "Globex Corp", slug: "globex", plan: starter, enabled: ["flag.advanced-analytics"] },
    { name: "Initech LLC", slug: "initech", plan: starter, enabled: ["flag.priority-support"] },
  ];
